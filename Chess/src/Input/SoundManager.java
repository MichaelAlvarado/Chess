...
public class SoundManager {
	...
	/**
	 * Description - Toggle Mute All Audio Channels
	 * PreCondition - the audio has to be added first by using addAudio(str) method 
	 * @author - Michael J. Alvarado
	 * @date Nov 30, 2020
	 */
	public void soundToggle() {
		soundOn = !soundOn;
		for (String clip: audioChannels.keySet()) {
			if(soundOn) {
				resumeAudio(clip);
			}
			else {
	...
	/**
	 * Description - Toggle Mute clip from Audio Channels 
	 * PreCondition - the audio has to be added first by using addAudio(str) method 
	 * @author - Michael J. Alvarado
	 * @date Nov 30, 2020
	 * @param str - name of the .wav file in res/music/. (Has to be added by using addAudio) 
	 */
	public void soundToggle(String clip) {
		soundOn = !soundOn;
		if(soundOn) {
			resumeAudio(clip);
		}
